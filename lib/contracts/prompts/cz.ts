...
export const cz: PromptBundle = {
  ...
  promptLang: {
    ...
    modeCompleteBlock: [
      ...
      '- Chybí-li **volitelný** údaj ze sekce C, vynech pouze zmínku o tomto údaji uvnitř věty a větu přeformuluj tak, aby dávala smysl — NIKDY za něj nevkládej `[DOPLNIT]`',
      '- Vynechává se vždy jen samotný chybějící údaj, NIKDY celý článek. Smlouva musí obsahovat všechny články požadované struktury včetně podpisových bloků',
    ...
    modeDraftBlock: [
      ...
      'Placeholder `[DOPLNIT: ...]` používej **pouze pro chybějící povinné údaje** — vlož ho přímo do věty na místo, kam údaj patří.',
      '',
      '- Chybí-li **volitelný** údaj ze sekce C, vynech pouze zmínku o tomto údaji uvnitř věty — NIKDY za něj nevkládej `[DOPLNIT]`',
      '- Vynechává se vždy jen samotný chybějící údaj, NIKDY celý článek. Smlouva musí i v tomto módu obsahovat všechny články požadované struktury, identifikaci obou stran a podpisové bloky',
    ...
    safetyRulesBlock: [
      ...
      'U chybějícího volitelného údaje vynech pouze zmínku o něm uvnitř věty — za volitelný údaj NIKDY nevkládej `[DOPLNIT]`.',
      'Vynechání se týká výhradně samotného údaje. Žádný chybějící údaj není důvodem vypustit celý článek smlouvy.',
      'Placeholder tedy smí vzniknout pouze z povinného pole uvedeného v sekci C jako kritické.',
      '',
      ...
      'NIKDY nepoužívej německé, rakouské ani anglické právo.',
