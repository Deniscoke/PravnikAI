...
export const cz: PromptBundle = {
  ...
  promptLang: {
    ...
    modeCompleteBlock: [
      ...
      '- Chybějící **volitelné** údaje ze sekce C zcela vynech a větu přeformuluj tak, aby dávala smysl i bez nich — NIKDY za ně nevkládej `[DOPLNIT]`',
    ...
    modeDraftBlock: [
      ...
      '',
      '- Chybějící **volitelné** údaje ze sekce C zcela vynech a větu přeformuluj — NIKDY za ně nevkládej `[DOPLNIT]`',
    ...
    safetyRulesBlock: [
      ...
      'Chybějící volitelné údaje zcela vynech a větu přeformuluj — za volitelný údaj NIKDY nevkládej `[DOPLNIT]`.',
