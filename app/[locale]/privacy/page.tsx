      ...
      <div className="legal-card">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <strong>Technické údaje:</strong> IP adresa, typ prohlížeče (pro bezpečnost a rate
              limiting)
            </li>
            <li>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Supabase, Inc.</strong> &mdash; autentizace a databáze (EU servery)
            </li>
            <li>
              <strong>OpenAI, Inc.</strong> &mdash; zpracování AI požadavků
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            Osobní údaje uchováváme po dobu trvání uživatelského účtu. Po smazání účtu jsou všechny
            osobní údaje nevratně odstraněny. Anonymizované auditní záznamy mohou být uchovány po dobu
            vyžadovanou zákonem.
          </p>
        </section>
